...
function Registro() {
   ...
   /*  const navigate = useNavigate(); */
    ...
    const onSubmitRegister = (e) => {
        ...
        const user = { username: usuario, contraseña: contraseña, email: email, confirmarContraseña: confirmarContraseña }
            ...
            <div className='div-general'>
                <form className='form-registro' >
                    ...
                    <div className='div-form1'>
                        ...
                        <input className='input1' type="text" name="Usuario" required placeholder='Usuario' />
                    </div>
                    <div className='div-form2'>
                        <label className='label2' htmlFor="email"></label>
                        <input className='input2' type="text" name="Email" required placeholder='Email' />
                    </div>
                    <div className='div-form3'>
                        <label className='label3' htmlFor="contraseña"></label>
                        <input className='input3' type="text" name="Contraseña" required placeholder='Contraseña' />
                    </div>
                    <div className='div-form4'>
                        <label className='label4' htmlFor="confirmar-contraseña"></label>
                        <input className='input4' type="text" name="confirmar-contraseña" required placeholder='Confirmar Contraseña' />
                    </div>
                {/* <Link to={"/login"} >  */} <button type='submit' className='but-registro'>REGISTRAR</button>{/* </Link> */}
                </form>
            </div>
