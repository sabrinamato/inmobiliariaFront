            ...
            <div className="div-contenedor">
                <form className="form">
                    ...
                    <div className="div-form">
                        ...
                        <input className="input1" type="text" name="Usuario" required placeholder="Ingrese su usuario" />
                    </div>
                    <div className="div-form2">
                        <label className="label2" htmlFor="password"></label>
                        <input className="input2" type="password" name="Password" required placeholder="Ingrese su contraseña" />
                    </div>
...
export default LoginComp
                                    ...
                                    //COMPONENTE DE OLVIDAR CONTRASEÑA//
