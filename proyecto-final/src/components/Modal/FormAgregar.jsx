    ...
    <div className="Main">
      ...
      <form onSubmit={handleSubmitNuevoDeportista}>
        ...
        <input
          ...
          required
        />
        <label htmlFor="tipo inmueble">Tipo inmueble:</label>
        <input
          className="inputForm"
          type="text"
          id="tipoInmueble"
        ...
        <input
          ...
          required
        />
        <label htmlFor="baño">Baños:</label>
        <input
          className="inputForm"
          type="text"
          id="baño"
          ...
          required
        />
        <label htmlFor="metros_edificio">Metros Edificio:</label>
        <input
          className="inputForm"
          type="numeric"
          id="metrosEdificio"
          ...
          required
        />
        <label htmlFor="metros_terreno">Metros Terreno:</label>
        <input
          className="inputForm"
          type="numeric"
          id="metrosTerreno"
